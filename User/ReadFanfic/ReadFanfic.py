# Form implementation generated from reading ui file 'D:\Users\LENOVO\baicuaThao\ProjectFinal\User\ReadFanfic\ReadFanfic.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("D:\\Users\\LENOVO\\baicuaThao\\ProjectFinal\\User\\ReadFanfic\\../../image/ReadFanfic.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.lineEdit_Title = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.lineEdit_Title.setGeometry(QtCore.QRect(260, 510, 301, 41))
        font = QtGui.QFont()
...
"}")
        ...
        self.lineEdit_Character.setGeometry(QtCore.QRect(260, 580, 301, 41))
        font = QtGui.QFont()
        font.setPointSize(13)
...
"}")
        ...
        self.lineEdit_Author.setGeometry(QtCore.QRect(820, 510, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(13)
...
"}")
        ...
        self.lineEdit_Date.setGeometry(QtCore.QRect(820, 580, 311, 41))
        font = QtGui.QFont()
        font.setPointSize(13)
...
"}")
        ...
        self.pushButton_Back.setGeometry(QtCore.QRect(920, 660, 211, 61))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:\\Users\\LENOVO\\baicuaThao\\ProjectFinal\\User\\ReadFanfic\\../../image/icon/search.webp"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
